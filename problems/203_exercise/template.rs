// ═══════════════════════════════════════════════════════════════════════════════
// 🦀 EXERCISE 203: JWT Authentication
// ═══════════════════════════════════════════════════════════════════════════════
//
// 📚 LEARNING OBJECTIVE:
//    JWT, HS256/RS256, auth middleware
//
// 🏢 REAL-WORLD SCENARIO:
//    Implement JWT authentication for APIs. Generate signed tokens on login, validate tokens in middleware, extract claims, and handle token expiration. Support both HMAC and RSA signing.
//
// 🎯 YOUR TASK:
...
fn main() {
    ...
    println!("Exercise 203: JWT Authentication");
