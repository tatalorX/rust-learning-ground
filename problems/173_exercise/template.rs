// ═══════════════════════════════════════════════════════════════════════════════
// 🦀 EXERCISE 173: Directory Sync Tool
// ═══════════════════════════════════════════════════════════════════════════════
//
// 📚 LEARNING OBJECTIVE:
//    directory traversal, file comparison, hashing
//
// 🏢 REAL-WORLD SCENARIO:
//    Create a rsync-like tool that synchronizes two directories. Compare files by modification time and checksum, copy new/changed files, and optionally delete files not present in source. Show progress du...
//
// 🎯 YOUR TASK:
...
fn main() {
    ...
    println!("Exercise 173: Directory Sync Tool");
