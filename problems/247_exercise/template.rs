// ═══════════════════════════════════════════════════════════════════════════════
// 🦀 EXERCISE 247: GeoJSON Parser
// ═══════════════════════════════════════════════════════════════════════════════
//
// 📚 LEARNING OBJECTIVE:
//    spatial data, GeoJSON, coordinate systems
//
// 🏢 REAL-WORLD SCENARIO:
//    Parse GeoJSON geographic data. Handle Point, LineString, Polygon geometries, parse FeatureCollections, and calculate bounding boxes. Validate coordinate reference systems.
//
// 🎯 YOUR TASK:
...
fn main() {
    ...
    println!("Exercise 247: GeoJSON Parser");
