// ═══════════════════════════════════════════════════════════════════════════════
// 🦀 EXERCISE 187: Git Hook Manager
// ═══════════════════════════════════════════════════════════════════════════════
//
// 📚 LEARNING OBJECTIVE:
//    git hooks, subprocess, exit codes
//
// 🏢 REAL-WORLD SCENARIO:
//    Build a git hooks framework. Run multiple scripts for each hook (pre-commit, pre-push), aggregate exit codes, run linters and tests, and block commits on failure. Display formatted output from each sc...
//
// 🎯 YOUR TASK:
...
fn main() {
    ...
    println!("Exercise 187: Git Hook Manager");
