// ═══════════════════════════════════════════════════════════════════════════════
// 🦀 EXERCISE 244: Pagination Cursor
// ═══════════════════════════════════════════════════════════════════════════════
//
// 📚 LEARNING OBJECTIVE:
//    cursor pagination, encoding, stable sorting
//
// 🏢 REAL-WORLD SCENARIO:
//    Implement cursor-based pagination for APIs. Encode cursors to avoid exposing internal IDs, handle stable ordering for tie-breaking, and support bidirectional navigation (next/prev). More reliable than...
//
// 🎯 YOUR TASK:
...
fn main() {
    ...
    println!("Exercise 244: Pagination Cursor");
