// ═══════════════════════════════════════════════════════════════════════════════
// 🦀 EXERCISE 190: Container Image Inspector
// ═══════════════════════════════════════════════════════════════════════════════
//
// 📚 LEARNING OBJECTIVE:
//    tar parsing, JSON layers, Docker/OCI
//
// 🏢 REAL-WORLD SCENARIO:
//    Parse Docker/OCI container images. Extract layer information, show image history, calculate total size per layer, and list files in each layer. Support both Docker and OCI image formats.
//
// 🎯 YOUR TASK:
...
fn main() {
    ...
    println!("Exercise 190: Container Image Inspector");
