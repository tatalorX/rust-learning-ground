// ═══════════════════════════════════════════════════════════════════════════════
// 🦀 EXERCISE 273: Structured Concurrency
// ═══════════════════════════════════════════════════════════════════════════════
//
// 📚 LEARNING OBJECTIVE:
//    nurseries, task scopes, cancellation trees
//
// 🏢 REAL-WORLD SCENARIO:
//    Build structured concurrency primitives. Ensure child tasks complete before parents, propagate cancellations hierarchically, handle errors in task groups, and prevent task leaks. Like Trio nurseries.
//
// 🎯 YOUR TASK:
...
fn main() {
    ...
    println!("Exercise 273: Structured Concurrency");
