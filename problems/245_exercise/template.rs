// ═══════════════════════════════════════════════════════════════════════════════
// 🦀 EXERCISE 245: Full-Text Search
// ═══════════════════════════════════════════════════════════════════════════════
//
// 📚 LEARNING OBJECTIVE:
//    inverted index, tokenization, ranking
//
// 🏢 REAL-WORLD SCENARIO:
//    Build a full-text search engine. Create inverted index mapping terms to documents, implement TF-IDF scoring for relevance, support phrase queries and boolean operators (AND, OR, NOT). Handle stemming.
//
// 🎯 YOUR TASK:
...
fn main() {
    ...
    println!("Exercise 245: Full-Text Search");
