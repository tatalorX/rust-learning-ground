// ═══════════════════════════════════════════════════════════════════════════════
// 🦀 EXERCISE 186: JSON Log Formatter
// ═══════════════════════════════════════════════════════════════════════════════
//
// 📚 LEARNING OBJECTIVE:
//    structured logging, jq-like queries, formatting
//
// 🏢 REAL-WORLD SCENARIO:
//    Create a log formatter for structured JSON logs. Parse JSON Lines format, filter by severity level, extract specific fields, and output in human-readable or CSV format. Support simple jq-like field se...
//
// 🎯 YOUR TASK:
...
fn main() {
    ...
    println!("Exercise 186: JSON Log Formatter");
