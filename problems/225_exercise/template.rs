// ═══════════════════════════════════════════════════════════════════════════════
// 🦀 EXERCISE 225: Connection Pool
// ═══════════════════════════════════════════════════════════════════════════════
//
// 📚 LEARNING OBJECTIVE:
//    pool management, idle timeout, max connections
//
// 🏢 REAL-WORLD SCENARIO:
//    Create an HTTP connection pool for a client. Reuse persistent connections, limit max connections per host, evict idle connections, and handle connection health checks. Critical for high-throughput cli...
//
// 🎯 YOUR TASK:
...
fn main() {
    ...
    println!("Exercise 225: Connection Pool");
