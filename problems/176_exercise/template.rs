// ═══════════════════════════════════════════════════════════════════════════════
// 🦀 EXERCISE 176: Process Manager
// ═══════════════════════════════════════════════════════════════════════════════
//
// 📚 LEARNING OBJECTIVE:
//    process spawning, signals, daemon processes
//
// 🏢 REAL-WORLD SCENARIO:
//    Create a process supervisor like systemd or supervisord. Start processes from config, monitor their health, restart on failure, handle graceful shutdown with SIGTERM, and log stdout/stderr to files.
//
// 🎯 YOUR TASK:
...
fn main() {
    ...
    println!("Exercise 176: Process Manager");
