// ═══════════════════════════════════════════════════════════════════════════════
// 🦀 EXERCISE 243: Diff Tool
// ═══════════════════════════════════════════════════════════════════════════════
//
// 📚 LEARNING OBJECTIVE:
//    Myers diff, LCS, unified format
//
// 🏢 REAL-WORLD SCENARIO:
//    Build a diff utility like diff or git diff. Implement Myers diff algorithm for optimal edit sequence, output unified diff format with context lines, and handle binary files. Support directory comparis...
//
// 🎯 YOUR TASK:
...
fn main() {
    ...
    println!("Exercise 243: Diff Tool");
