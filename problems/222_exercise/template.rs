// ═══════════════════════════════════════════════════════════════════════════════
// 🦀 EXERCISE 222: DNS Resolver
// ═══════════════════════════════════════════════════════════════════════════════
//
// 📚 LEARNING OBJECTIVE:
//    DNS protocol, UDP sockets, caching
//
// 🏢 REAL-WORLD SCENARIO:
//    Build a DNS resolver. Construct DNS query packets over UDP, parse response records, implement a local cache with TTL, and support A, AAAA, and CNAME records. Handle truncated responses with TCP fallba...
//
// 🎯 YOUR TASK:
...
fn main() {
    ...
    println!("Exercise 222: DNS Resolver");
