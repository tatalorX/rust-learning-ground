// ═══════════════════════════════════════════════════════════════════════════════
// 🦀 EXERCISE 214: Server-Sent Events
// ═══════════════════════════════════════════════════════════════════════════════
//
// 📚 LEARNING OBJECTIVE:
//    SSE protocol, streaming, reconnection
//
// 🏢 REAL-WORLD SCENARIO:
//    Implement Server-Sent Events for live updates. Send events from server to browser, handle client reconnections with Last-Event-ID, support multiple event types, and manage connection lifecycle.
//
// 🎯 YOUR TASK:
...
fn main() {
    ...
    println!("Exercise 214: Server-Sent Events");
