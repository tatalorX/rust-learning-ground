// ═══════════════════════════════════════════════════════════════════════════════
// 🦀 EXERCISE 178: Disk Usage Analyzer
// ═══════════════════════════════════════════════════════════════════════════════
//
// 📚 LEARNING OBJECTIVE:
//    recursive traversal, size calculation, tree display
//
// 🏢 REAL-WORLD SCENARIO:
//    Build a du-like tool that analyzes disk usage. Recursively scan directories, calculate sizes, display results as a sorted tree, and identify the largest files. Handle permission errors gracefully.
//
// 🎯 YOUR TASK:
...
fn main() {
    ...
    println!("Exercise 178: Disk Usage Analyzer");
