// ═══════════════════════════════════════════════════════════════════════════════
// 🦀 EXERCISE 276: Barrier Synchronization
// ═══════════════════════════════════════════════════════════════════════════════
//
// 📚 LEARNING OBJECTIVE:
//    CyclicBarrier, phase coordination, reset
//
// 🏢 REAL-WORLD SCENARIO:
//    Build a cyclic barrier for coordinating threads. Block threads until all arrive, execute barrier action, support barrier reset for reuse, and handle broken barriers. Used in parallel algorithms.
//
// 🎯 YOUR TASK:
...
fn main() {
    ...
    println!("Exercise 276: Barrier Synchronization");
