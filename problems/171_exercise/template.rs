// ═══════════════════════════════════════════════════════════════════════════════
// 🦀 EXERCISE 171: Log Analyzer
// ═══════════════════════════════════════════════════════════════════════════════
//
// 📚 LEARNING OBJECTIVE:
//    file reading, pattern matching, streaming
//
// 🏢 REAL-WORLD SCENARIO:
//    Your DevOps team needs a tool to analyze server logs. Parse nginx logs to extract IP addresses, status codes, and find the top 10 most frequent visitors. Handle large files efficiently without loading...
//
// 🎯 YOUR TASK:
...
fn main() {
    ...
    println!("Exercise 171: Log Analyzer");
