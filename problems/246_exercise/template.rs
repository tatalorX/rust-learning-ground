// ═══════════════════════════════════════════════════════════════════════════════
// 🦀 EXERCISE 246: Time Series Database
// ═══════════════════════════════════════════════════════════════════════════════
//
// 📚 LEARNING OBJECTIVE:
...
//
// 🏢 REAL-WORLD SCENARIO:
//    Implement a minimal time series database. Store metrics with timestamps, compress using delta-of-delta encoding, downsample old data with rollups, and query time ranges efficiently. Like InfluxDB or P...
//
// 🎯 YOUR TASK:
...
fn main() {
    ...
    println!("Exercise 246: Time Series Database");
