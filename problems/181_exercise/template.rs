// ═══════════════════════════════════════════════════════════════════════════════
// 🦀 EXERCISE 181: Parallel Grep
// ═══════════════════════════════════════════════════════════════════════════════
//
// 📚 LEARNING OBJECTIVE:
//    parallel processing,  Rayon, text search
//
// 🏢 REAL-WORLD SCENARIO:
//    Implement ripgrep-like parallel search. Search multiple files concurrently using threads, print matching lines with file names and line numbers, support regex patterns, and respect .gitignore files.
//
// 🎯 YOUR TASK:
...
fn main() {
    ...
    println!("Exercise 181: Parallel Grep");
